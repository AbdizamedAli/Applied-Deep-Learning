...
class CNN(nn.Module):
    def __init__(self, height: int, width: int, channels: int, class_count: int):
        ...
        self.batch_norm_1_left = nn.BatchNorm2d(16)
        ...
        self.batch_norm_1_right = nn.BatchNorm2d(16)
        ...
        self.batch_norm_2_left = nn.BatchNorm2d(16)
        ...
        self.batch_norm_2_right = nn.BatchNorm2d(32)
        ...
        self.batch_norm_3_left = nn.BatchNorm2d(64)
        ...
        self.batch_norm_3_right = nn.BatchNorm2d(64)
        ...
        self.batch_norm_4_left = nn.BatchNorm2d(128)
        ...
        self.batch_norm_4_right = nn.BatchNorm2d(128)



        self.fc1 = nn.Linear(10240, 200)
        self.initialise_layer(self.fc1)
        self.batch_norm_final = nn.BatchNorm1d(200)
    ...
    def forward(self, wav: torch.Tensor) -> torch.Tensor:
        right_x = F.leaky_relu(self.batch_norm_1_right(self.conv1_right(wav)), 0.3)
        right_x = self.pool1_right(right_x)

        right_x = F.leaky_relu(self.batch_norm_2_right(self.conv2_right(right_x)), 0.3)
        right_x = self.pool2_right(right_x)

        right_x = F.leaky_relu(self.batch_norm_3_right(self.conv3_right(right_x)), 0.3)
        right_x = self.pool3_right(right_x)

        right_x = F.leaky_relu(self.batch_norm_4_right(self.conv4_right(right_x)), 0.3)
        right_x = self.pool4_right(right_x)



        left_x = F.leaky_relu(self.batch_norm_1_left(self.conv1_left(wav)), 0.3)
        left_x = self.pool1_left(left_x)

        left_x = F.leaky_relu(self.batch_norm_2_left(self.conv2_left(left_x)), 0.3)
        left_x = self.pool1_left(left_x)

        left_x = F.leaky_relu(self.batch_norm_3_left(self.conv3_left(left_x)), 0.3)
        left_x = self.pool3_left(left_x)

        left_x = F.leaky_relu(self.batch_norm_4_left(self.conv4_left(left_x)), 0.3)
        ...
        x = F.leaky_relu(self.batch_norm_final(self.fc1(left_right_merged)), 0.3)
